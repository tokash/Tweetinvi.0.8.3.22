...
namespace Tweetinvi
{
    ...
    public class Message : TwitterObject, IMessage
    {
        ...
        public bool Publish(long receiverId, IToken token = null)
        {
            ...
            token.ExecutePOSTQuery(String.Format(Resources.Messages_SendToUserId, _text.TwitterEncode(), receiverId), Populate);
        ...
        public bool Publish(IUser receiver = null, IToken token = null)
        {
            ...
            {
                token.ExecutePOSTQuery(String.Format(Resources.Messages_SendToUserId, _text.TwitterEncode(), messageReceiver.Id), Populate);
            }
            else
            {
                token.ExecutePOSTQuery(String.Format(Resources.Messages_SendToUserScreenName, _text.TwitterEncode(), messageReceiver.ScreenName), Populate);
            }
