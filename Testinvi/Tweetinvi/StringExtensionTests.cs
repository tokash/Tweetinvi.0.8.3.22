...
namespace Testinvi.Tweetinvi
{
    ...
    public class StringExtensionTests
    {
        ...
        [TestMethod]
        public void TestLengthWithUrlContainingParameter()
        {
            string text = "#role Software Development Manager / Recruitment Solution Sales - Home Based - Covering Home Counties - Up to £30,0 http://pnxj.me?dxr=14587";

            int twitterLength = StringExtension.TweetLenght(text);

            Assert.AreEqual(twitterLength, 138);
        }
